...
class TestFastUpgrade_to_4_0_1(object):
    @classmethod
    def setup_class(cls):
        os.environ['UTILITIES_UNIT_TESTING'] = "2"
    ...
    def test_fast_reboot_upgrade_to_4_0_1(self):
        db_before_migrate = 'cross_branch_upgrade_to_4_0_1_input'
        db_after_migrate = 'cross_branch_upgrade_to_4_0_1_expected'
        device_info.get_sonic_version_info = get_sonic_version_info_mlnx
        db = self.mock_dedicated_config_db(db_before_migrate)
        import db_migrator
        dbmgtr = db_migrator.DBMigrator(None)
